while(true){
    ...
    for(var j=0; j<10; j++){
        ...
        for(var i=0; i<5; i++){
            click2(1608,1010,0.5)                // 加被动     
            click2(1600,760,0.5)                 // 加一技能                       
            click2(1700,593,0.5)                 // 加二技能
            click2(1906,508,0.5)                 // 加大招
        }
        ...
        sleep(236000)                            // 等第三波
        click2(578,492,1.0)                      // 刷兵加速
        for(var i=0; i<15; i++)
            click2(1158,982,2)                   // 购买
        click2(790,128,1)                        // 关闭商店
        for(var i=0; i < 70; i++){
            click2(1470,950,0.5)                 // 攻击道具
            click2(2200,990,0.6)                 // 返回大厅
            log(i)
        }
        click2(1260,55,3)                       // 离开队伍
    }
}
