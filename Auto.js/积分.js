...
function brush(){
    ...
    swipe2(370,840,275,640,2800,0.5);           // 走到防守位置
    swipe2(2000,600,2230,640,500,0.5);          // 瞄准下路
    click2(1470,950,272);                       // 使用消除防御塔==
    click2(99,500,0.5);                         // 打开商店
    click2(96,710,0.5);                         // 普通道具
    click2(558,476,0.5);                        // 刷兵加速
    click2(1158,982,0.5);                       // 购买
    click2(790,128,0.5);                        // 关闭商店
    click2(1574,600,0.5);                       // 使用额外技能
    swipe2(370,840,440,960,5000,0.3);           // 走到角落
    click2(495,238,0.5);                        // 击杀数商店
    click2(1860,400,0.5);                       // 武神甲
    swipe2(370,840,290,640,3200,0.5);           // 走到防守位置
    swipe2(2000,610,2230,395,500,16);           // 瞄准中路==
    click2(99,500,0.5);                         // 打开商店
    click2(96,710,0.5);                         // 普通道具
    click2(558,476,0.5);                        // 刷兵加速
    for(var i=0; i<16; i++)
